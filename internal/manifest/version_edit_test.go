			...
			NewFiles: []NewFileEntry{
				{
					...
					Meta: &FileMetadata{
						...
						Size:             8050,
						CreationTime:     805030,
						SmallestPointKey: base.DecodeInternalKey([]byte("abc\x00\x01\x02\x03\x04\x05\x06\x07")),
						LargestPointKey:  base.DecodeInternalKey([]byte("xyz\x01\xff\xfe\xfd\xfc\xfb\xfa\xf9")),
					},
				},
				{
					Level: 6,
					Meta: &FileMetadata{
						...
						Size:                8060,
						CreationTime:        806040,
						SmallestPointKey:    base.DecodeInternalKey([]byte("A\x00\x01\x02\x03\x04\x05\x06\x07")),
						LargestPointKey:     base.DecodeInternalKey([]byte("Z\x01\xff\xfe\xfd\xfc\xfb\xfa\xf9")),
						SmallestSeqNum:      3,
						LargestSeqNum:       5,
					...
					NewFiles: []NewFileEntry{
						{
							...
							Meta: &FileMetadata{
								FileNum:          4,
								Size:             986,
								SmallestPointKey: base.MakeInternalKey([]byte("bar"), 5, base.InternalKeyKindDelete),
								LargestPointKey:  base.MakeInternalKey([]byte("foo"), 4, base.InternalKeyKindSet),
								SmallestSeqNum:   3,
								LargestSeqNum:    5,
							},
						},
